...
class ShowTripBookingsByDriver extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            tripBookings: []
    ...
    getTripBooking(event) {
        const id = event.target.driverId.value;
        AdminService.getTripBookingsByDriverId(id).then(response => {
            this.setState({
    ...
    render() {
        ...
        return (
            <div>
                ...
                <h3 align="center"> Trip Booking Information of Driver</h3>
                <div className="container form body form-body">
                    <form onSubmit={this.getTripBooking}>
                        <input type="text" name="driverId" placeholder="Enter the id to be searched" className="form-control" />
...
export default ShowTripBookingsByDriver;